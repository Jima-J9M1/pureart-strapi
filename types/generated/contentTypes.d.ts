...
export interface ApiArtistArtist extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    ticktok: Schema.Attribute.String;
...
export interface ApiGlobalValueGlobalValue extends Struct.SingleTypeSchema {
  collectionName: 'global_values';
  info: {
    displayName: 'globalValue';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    favicon: Schema.Attribute.Media<'images' | 'files', true> &
      Schema.Attribute.Required;
